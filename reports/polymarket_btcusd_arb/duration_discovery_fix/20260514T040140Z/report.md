...
|----------|---------------|----------------|------------------|
| 5m | 2 | 2 | BINANCE_BTCUSDT |
| 15m | 2 | 2 | BINANCE_BTCUSDT |
| 1h | 2 | 2 | BINANCE_BTCUSDT |
| 4h | 1 | 1 | CHAINLINK_BTCUSD |

## Active Market Availability

- **5m**: Product exists (2 found) with 2 active market(s).
- **15m**: Product exists (2 found) with 2 active market(s).
...
|----------|-----------------|-------------|
| 5m | BINANCE_BTCUSDT | Binance fair-prob model applicable |
| 5m | BINANCE_BTCUSDT | Binance fair-prob model applicable |
| 15m | BINANCE_BTCUSDT | Binance fair-prob model applicable |
| 15m | BINANCE_BTCUSDT | Binance fair-prob model applicable |
...
| Duration | Events | Actionable TWO_SIDED | EXCHANGE_BOUND | FALLBACK_MIN_MAX | Median Spread (bps) |
|----------|--------|---------------------|-----------------|------------------|--------------------|
| 15m | 2 | 0 | 2 | 0 | 19600.0 |
| 1h | 2 | 0 | 1 | 0 | 19600.0 |
| 4h | 1 | 0 | 0 | 0 | N/A |
...
No actionable two-sided books were observed at any duration.
...
**Overall: DURATION_PROBE_NO_USABLE_BOOKS_IN_OBSERVED_ACTIVE_MARKETS**

Reason: active_books_observed_but_no_actionable_two_sided_at_any_duration

- **15m**: DURATION_ACTIVE_MARKET_NO_USABLE_BOOK
- **1h**: DURATION_MARKET_EXISTS_NEEDS_QUOTE_OBSERVATION
- **4h**: DURATION_MARKET_EXISTS_NEEDS_QUOTE_OBSERVATION
- **5m**: DURATION_ACTIVE_MARKET_NO_USABLE_BOOK
...
No actionable two-sided books were observed in active markets.

Do not execute. Do not start Phase 3.

Re-observe when markets are active, or test a new hypothesis.
