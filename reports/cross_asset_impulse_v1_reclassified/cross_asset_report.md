...
- **Pairs with sufficient range:** 0
- **Pairs with ≥ min_events signals:** 0
...
## Event Counts
- **Total signal events:** 12455
- **Long-executable signals:** 5440
- **Downside diagnostic signals:** 7015

## Best Source-Target Pair
- `coinbase:BTC/USDT->kraken:LINK/USD`: mean net return = -44.13 bps

## Worst Source-Target Pair
- `coinbase:ETH/USDT->kraken:SOL/USD`: mean net return = -47.21 bps

## Best Long-Executable Group
- `coinbase:BTC/USDT->kraken:SOL/USD`: mean net return = -43.60 bps

## Best Downside Diagnostic Group
- `coinbase:BTC/USDT->kraken:LINK/USD`: mean net return = -43.56 bps
...
- one_or_more_streams_failed_subscription
- one_or_more_streams_produced_zero_ticks
- insufficient_price_range: source<30.0bps or target<30.0bps in all overlapping pairs
