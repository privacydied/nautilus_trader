...
from venue_agnostic_signal_observer.discovery.exceptions import GridCellCountMismatchError
from venue_agnostic_signal_observer.discovery.exceptions import GridHashMismatchError
from venue_agnostic_signal_observer.discovery.exceptions import GridLockValidationError
from venue_agnostic_signal_observer.discovery.grid_lock import GRID_LOCK_TYPE
from venue_agnostic_signal_observer.discovery.grid_lock import DiscoveryGridLock
...
from venue_agnostic_signal_observer.discovery.grid_lock import locks_are_semantically_equal
from venue_agnostic_signal_observer.discovery.grid_lock import save_grid_lock
from venue_agnostic_signal_observer.discovery.grid_lock import validate_grid_lock
...
class TestGridLock:
    ...
    def test_semantically_identical_locks_accepted(self, golden_spec):
        ...
        dict_b = dict(sorted(common.items(), reverse=True))
