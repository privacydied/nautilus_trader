...
def shadow_result_to_row(result: ShadowOpportunityResult) -> dict[str, Any]:
    ...
    return {
        ...
        "yes_cumulative_fillable_volume": result.yes_fill.cumulative_fillable_volume,
        "no_cumulative_fillable_volume": result.no_fill.cumulative_fillable_volume,
        "yes_quote_price": opp.yes_quote.price,
        "yes_quote_size": opp.yes_quote.size,
        "yes_quote_side": opp.yes_quote.quote_side,
        "no_quote_price": opp.no_quote.price,
        "no_quote_size": opp.no_quote.size,
        "no_quote_side": opp.no_quote.quote_side,
